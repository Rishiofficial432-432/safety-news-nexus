...
import { Bell, Home, Shield, AlertTriangle, Newspaper, CloudLightning, HeartPulse, Globe, ShieldAlert, PanelLeftClose } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Health Advisories", path: "/health", icon: HeartPulse }, // Replaced Virus with HeartPulse
